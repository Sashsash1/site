        ...
        <div class="main-content col-md-9">
            ...
            <div class="post row">
                <div class="img col-12 col-md-4">
                    <div class="tooltipe">
                        <img src="assets/IMG/статьи/Редактор2.jpg" class="img-post" alt="creator 2">
                        <span class="Tooltext"><span class="span__name">Nikolay Dmitriev</span><br>
                        Man of the world
                        </span>
                    </div>
                </div>
                <div class="post_text col-12 col-md-8">
                    <h2>
                        <a href="<?php echo BASE_URL . 'topik1.php';?>">10 creepy and beautiful ghost towns</a>
                    </h2>
                    <p class="far">May 18, 2022</p>
                    <p class="preview-text">Places lost in time.</p>
                    <button class="btn-post anim">
                        <a href="<?php echo BASE_URL . 'topik1.php';?>">Read</a>
                    </button>
                </div>
            </div>
            ...
            <div class="post row">
               <div class="img col-12 col-md-4">
                ...
                <div class="post_text col-9 col-md-8">
                    <h2>
                        <a href="<?=BASE_URL . 'topik2.php?post=' . $post['id']; ?>"><?=substr($post['title'], 0, 120) . '...' ?></a>
                    </h2>
