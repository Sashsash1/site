...
<head>
    ...
    <title>Добро пожаловать ООО Гала-Тур</title>
    ...
    <div class="page__main-block main-block">
        <div class="main-block__container _container">
            <div class="main-block__body">
                <h1 class="main-block__title _anim-items _anim-no-hide">Welcome to <br> the VR-Tour</h1>
                <div class="main-block__text _anim-items">Travel with people from anywhere in&nbsp;the world. Explore new
                    territories, <br> discover unknown paths and create new experiences with&nbsp;us.</div>
                <div class="main-block__button">
                    <a href="#" class="main-block__button_a _anim-items _anim-no-hide">View more &gt;</a>
                </div>
            </div>
        </div>
    </div>
...
<div id="draw"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <defs>
        <style>
            ...
            .cls-11, .cls-12, .cls-13, .cls-14, .cls-15, .cls-16, .cls-9 {
                fill: #2d284f;
            }
...
<!--------------- / АНИМАЦИЯ ФОНА---------------------------------------------------------->
<!--------------------achievements__page-------------------------------------------------->
<div class="achievements__page">
    <div class="achievements__container _container">
        <div class="side__title"><span class="colortext">01</span>&nbsp;/ VR For Everyone</div>
        <div class="achievements__header header-block">
            <h2 class="header-block__title _anim-items">VR for <br> <span class="colortext"> Everyone</span></h2>
            <hr>
            <div class="header-block__sub-title _anim-items">Join us for an epic week of hiking, team-bonding and digital
                <br>
                detoxing. This month, one-time only, in <span class="colortext"> Jungle</span>.
            </div>
        </div>

        <div class="achievements__body">
            <div class="achievements__column _anim-items">
                <div class="card">
                    <div class="achievements__text">HIGH STANDARDS <br> SERVICE</div>
                    <div class="achievements__image">
                        <img src="assets/IMG/block_advantades/card1.jpg" alt="HIGH STANDARDS SERVICE">
                    </div>
                </div>
            </div>
            <div class="achievements__column _anim-items">
                <div class="card ">
                    <div class="achievements__text">REPUTATION OF&nbsp;<br>RELIABLE PARTNER</div>
                    <div class="achievements__image">
                        <img src="assets/IMG/block_advantades/card2.jpg" alt="REPUTATION OF RELIABLE PARTNER">
                    </div>
                </div>
            </div>
            <div class="achievements__column _anim-items">
                <div class="card">
                    <div class="achievements__text"><br>CREATIVITY</div>
                    <div class="achievements__image">
                        <img src="assets/IMG/block_advantades/card3.png" alt="CREATIVITY">
                    </div>
                </div>
            </div>
        </div>
...
<!-------------------- / achievements__page-------------------------------------------------->
<!----------------ADVERSTISING PAGE---------------------------------------->
<div class="advertising__page">
    <div class="advertising__container _container">
        <div class="side__title-right"><span class="colortext">02</span>&nbsp;/ Your Fabulous Journey</div>
        <div class="advertising__header-right header-block">
            <h2 class="header-block__title _anim-items">Your Fabulous <br> <span class="colortext">Journey </span></h2>
            <hr class="hr-right">
            <div class="header-block__sub-title _anim-items">The Amazon Jungle Cruise is a new tropical-themed VR resort
                that offers
                <br> visitors the opportunity to walk through the lost forests, get to know the local <br> inhabitants
                and the <span class="colortext">Yanomami tribe</span>.
            </div>
        </div>
        <div class="advertising_list">
            <li class="advertising__title _anim-items ">Distance</li>
            <li class="advertising__sub-title _anim-items ">436 km</li>
            <li class="advertising__title _anim-items">Time</li>
            <li class="advertising__sub-title _anim-items ">2 days</li>
            <li class="advertising__title _anim-items">Transhipment points</li>
            <li class="advertising__sub-title _anim-items">5</li>
        </div>
    </div>
    <div class="advertising__body">
        <div class="advertising__image">
            <div class="advertising__image-map">
                <img src="assets/IMG/block-advertising/PATH2.png" alt="Map">
            </div>
            <div class="advertising__image-human">
                <img src="assets/IMG/block-advertising/WithGlass.png" alt="Human">
            </div>
            <hr class="hr-blue">
        </div>
        <div class="advertising__image-cloud1">
            <img src="assets/IMG/block-advertising/cloud1.png" alt="Cloud">
        </div>
        <div class="advertising__image-cloud2">
            <img src="assets/IMG/block-advertising/cloud2.png" alt="Cloud">
        </div>
    </div>
</div>
<!---------------- / ADVERSTISING PAGE---------------------------------------->
...
<div class="choice__page">
    <div class="choice__container _container">
        <div class="side__title-horizontal lng-sidetitle3"><span class="colortext">03</span>&nbsp;/ Choose Your Adventure</div>
    </div>
    <div class="choice__image-cloudes">
        <div class="choice__image-cloude4">
            <img src="assets/IMG/block_choice/cloude4.png" alt="cloude">
        </div>
        <div class="choice__image-cloude5">
            <img src="assets/IMG/block_choice/cloide5.png" alt="cloude">
        </div>
        <div class="choice__image-cloude6">
            <img src="assets/IMG/block_choice/cloude6.png" alt="cloude">
        </div>
    </div>
    <div class="choice__header header-block">
        <h2 class="header-block__title-choice _anim-items ">Choose Your <br> <span class="colortext">Adventure</span></h2>
        <div class="header-block__sub-title-сhoice _anim-items ">The jungle is completely neutral. Initially, there was no
            hostility or
            <br> disposition towards the human race in them. However, it was <br> worthwhile to study the laws of
            nature, tune in to the frequency of <br> the jungle, become part of their essence, and they turned into a
            <br> <span class="colortext">fantastic friend</span>, <span class="colortext">willingly providing help
        </span> and <span class="colortext">shelter</span>.
        </div>
        <div class="main-block__button-choice">
            <a href="<?php echo BASE_URL . 'SimpleT.php';?>" class="main-block__button_a-choice _anim-items ">View more &gt;</a>
        </div>
    </div>
    <div class="choice__image">
        <img src="assets/IMG/block_choice/humanWithNoote.png" alt="human on mountain">
    </div>
</div>
<!---------------- / CHOICE PAGE---------------------------------------------->
<!-----------FOOTER---------------------------------------------------------->
